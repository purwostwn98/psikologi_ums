...
<div class="page-content container bg-white">
    <div class="page-header border-0 justify-content-between">
        ...
        <div class="page-tools pt-1 mt-3 mt-sm-0 mb-sm-n1"><a href="/peneliti/daftar-responden-survei?instrument=<?=$_GET['instrument']?>&code_survei=<?=$_GET['code_survei']?>" class="btn btn-xs btn-secondary"><i class="fa fa-arrow-left text-110 align-text-bottom mr-1"></i> | Back</a></div>
